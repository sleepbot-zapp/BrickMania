...
def game_over(score, screen, track2, track3, HEIGHT, WIDTH, scale, type_=0,):
    mixer.music.pause()
    track3.play()
    ...
    screen.blit(font_for_game_over.render(f"{['Your', "Model"][type_]} Score = {score}", True, Color.BLUE), ((WIDTH // 2 - text3.get_width() / 2) * scale, (HEIGHT // 2 + 40) * scale))
    flip()
