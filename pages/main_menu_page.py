...
class MainMenu(Page):
    ...
    def generate(self, color: Color, brick_width: typing.Union[int, float], brick_height: typing.Union[int, float], clock) -> int:
        ...
        while True:
            ...
            self.screen.blit(title_text, ((self.width// 2 - title_text.get_width() // 2) * self.scale, (self.height // 2 - 150) * self.scale))
