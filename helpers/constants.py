...
class Config(BaseModel):
    ...
    @classmethod
    def open(cls) -> 'Config':
        return cls.model_validate_json(open(os.getenv("BRICKMANIA_CONFIG", "./constants.json")).read())
...
WIDTH, HEIGHT = int(constants.screen.width * SCALE), int(constants.screen.height * SCALE)
...
bottom_font = pygame.font.SysFont(None, int(constants.game_constants.font_size.game_over * SCALE))
...
track3 = pygame.mixer.Sound(get_music_path(constants, 4))
